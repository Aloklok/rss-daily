...
import { useStarredArticles } from '@/domains/reading/hooks/useArticles'; // 导入新的 Hook
...
export const useSidebar = ({
  ...
  // 1. 【核心修改】从 useStarredArticles 中解构 isFetching，传入 initialStarredHeaders 和 tableName
  const {
