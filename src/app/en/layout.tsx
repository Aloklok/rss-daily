...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        description:
            'Aggregating insights from global tech blogs and architecture practices.',
    },
    ...
    return (
        <html lang="en" className={`${inter.variable} ${playfair.variable}`}>
          ...
          `}</style>
                ...
                <Providers>
                    <MainLayoutServer initialDates={dates} initialAvailableFilters={availableFilters} dict={en}>
                        {children}
                    </MainLayoutServer>
                    <GlobalUI dict={en} />
                </Providers>
