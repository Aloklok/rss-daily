        ...
        <div className={`relative ${className}`}>
            ...
            {isMenuOpen && !disabled && (
                <>
                    ...
                    <div
                        className={`scrollbar-thin scrollbar-thumb-stone-300 dark:scrollbar-thumb-white/10 absolute z-[50] bottom-full mb-3 max-h-[400px] w-64 overflow-y-auto rounded-2xl border border-white/20 bg-white/90 shadow-2xl backdrop-blur-2xl dark:bg-stone-900/90 ${align === 'right' ? 'right-0' : 'left-[-110px]'
                            }`}
                    >
                        <div className="space-y-1 p-2">
                            {MODELS.map((m) => (
                                <button
                                    ...
                                    className={`flex w-full flex-col items-start rounded-xl px-4 py-3 text-left transition-all ${selectedModel === m.id
                                ...
                                >
                                    <div className="flex w-full items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <span
                                                className={`rounded-md px-1.5 py-0.5 text-[9px] font-black tracking-tight uppercase shadow-sm ${selectedModel === m.id
