      ...
      <div className="flex flex-1 flex-row overflow-hidden">
        ...
        <div className="flex w-64 flex-col border-r border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
          ...
          <div
            ...
            style={{
              opacity: selectedSourceId ? 1 : 0.5,
              pointerEvents: selectedSourceId ? 'auto' : 'none',
            }}
          >
          ...
          <div className="flex h-64 flex-col overflow-hidden bg-gray-50 dark:bg-black/40">
            ...
            <div className="scrollbar-thin flex-1 overflow-y-auto p-2 font-mono text-[10px]">
              {logs.length === 0 && <div className="p-2 text-gray-400 italic">就绪...</div>}
              {logs.map((log, i) => (
                <div
                  key={i}
                  className={`mb-1 break-all ${log.type === 'error' ? 'text-red-500' : log.type === 'success' ? 'text-green-600' : 'text-gray-600 dark:text-gray-400'}`}
                >
        ...
        <div className="flex flex-1 flex-col bg-white dark:bg-transparent">
          ...
          {/* Content Area */}
          <div className="scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-800 flex flex-1 flex-col overflow-y-auto bg-white p-0 dark:bg-transparent">
            {/* Empty State */}
            ...
            {processingState === 'fetching_candidates' && (
              <div className="flex h-full flex-col items-center justify-center space-y-3">
                ...
                <div className="animate-pulse text-sm text-gray-500">正在索引文章数据...</div>
              </div>
            )}
                        ...
                        >
                          <div className="flex items-start justify-between gap-2">
                            <div>
                              ...
                              >
                                <button
                                  ...
                                  className={`text-left underline-offset-2 hover:underline ${isDone ? 'decoration-gray-400' : 'decoration-indigo-400'}`}
                                >
                                  {c.title}
                                </button>
                              </div>
                              <div className="mt-1 flex items-center gap-2 text-xs text-gray-400">
                                ...
                                {c.sourceName && (
                                  <>
                                    ...
                                    <span className="max-w-[200px] truncate">{c.sourceName}</span>
                                  </>
                                )}
                              </div>
                            </div>
                            <div className="flex-shrink-0 pt-0.5">
                              ...
                              {isProcessed && (
                                <span className="inline-flex items-center rounded border border-green-200 bg-green-50 px-1.5 py-0.5 text-[10px] text-green-700 dark:border-green-900/30 dark:bg-green-900/20 dark:text-green-400">
                                  完成
                                </span>
                              )}
                            </div>
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400">
                  ...
                  <input
                    ...
                    className="w-12 rounded border border-gray-300 bg-white px-1.5 py-1 text-center text-xs shadow-sm focus:border-indigo-500 focus:outline-none dark:border-gray-700 dark:bg-black"
                    min={1}
                    max={50}
                  />
                </div>
